...
public class admin_Sad {
	public static void main(String[] args) throws Throwable {
		WebDriver driver = new EdgeDriver();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		Actions actions = new Actions(driver);
		String[] names = {
				"admin Chem 00 exam 1",
				"admin chem 00exam 2",
				"admin chem 00exam 3"
				};
			...
			driver.findElement(By.id("username")).sendKeys("omkark");
			...
			actions.sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,  Keys.SPACE).perform();
