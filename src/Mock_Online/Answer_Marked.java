	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
         ...
         for (int subject = 0; subject < 4; subject++) {
             ...
             for (int answeredQuestions = 0; answeredQuestions < 50; answeredQuestions++) {
                 
                 WebElement selectOption = driver.findElement(By.xpath("//div[4]//span[1]//label[1]"));
                 selectOption.click();

                
                 WebElement next = driver.findElement(By.xpath("//button[@id='skip']"));
                 next.click();
             }
	              System.out.println("Answer 50 questions");
